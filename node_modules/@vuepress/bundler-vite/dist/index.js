// src/build/build.ts
import { chalk, fs as fs3, importFile, ora, withSpinner } from "@vuepress/utils";
...
var renderPageStyles = ({
  app,
  outputCssAsset
}) => outputCssAsset ? `<link rel="stylesheet" href="${app.options.base}${outputCssAsset.fileName}">` : "";
...
var dev = async (options, app) => {
  ...
  await server.listen();
  const viteVersion = (await fs4.readJSON(require2.resolve("vite/package.json"))).version;
